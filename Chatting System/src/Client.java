...
public class Client  extends JFrame implements ActionListener {
	...
	Client(){
		...
		// for status typing..
		// action listener is an interface here and actionperformed is an abstarct 
		// method so we have to override that method.
		...
		// as we change from active to typing takes 2 sec
	...
	// getConetentPane()-> pure bakground ko uthaega or set background change krega
		...
		setLocation(800,150); // frame ki location
